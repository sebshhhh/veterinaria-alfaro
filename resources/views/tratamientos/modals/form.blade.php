                    ...
                    <div class="rounded-[24px] border border-slate-200 bg-slate-50 p-5 shadow-sm">
                        ...
                        <div class="mt-4 rounded-[22px] bg-white p-4 shadow-sm">
                            <div class="flex items-start gap-4">
                                <img id="tratamientoMascotaPhoto" src="{{ asset('storage/default.png') }}" alt="Vista de mascota" class="h-24 w-24 rounded-[20px] object-cover" onerror="this.onerror=null;this.src='{{ asset('storage/default.png') }}';">
