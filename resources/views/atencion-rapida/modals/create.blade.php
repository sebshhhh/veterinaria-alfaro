...
<div id="atencionRapidaModal"
     ...
     class="workspace-modal fixed inset-0 z-50 hidden items-center justify-center overflow-y-auto bg-slate-950/60 px-3 py-4 sm:px-6 sm:py-6"
     aria-hidden="true">
    <div class="modal-card my-auto flex max-h-[calc(100vh-3rem)] w-full max-w-[96rem] scale-95 flex-col overflow-hidden rounded-[32px] border border-slate-200 bg-white opacity-0 shadow-2xl shadow-slate-900/20 transition-all duration-200 ease-out">
        <div class="shrink-0 border-b border-slate-100 bg-white px-6 py-5 sm:px-7 sm:py-6">
            <div class="flex items-start justify-between gap-4">
                <div>
                    <p class="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">Atención clínica</p>
                    <h3 class="mt-1 text-[2rem] font-bold tracking-tight text-slate-900">Registrar atención clínica</h3>
                    <p id="atencionRapidaSummary" class="mt-1.5 text-base text-slate-500">Usa el mismo flujo de Atender cita: registra solo lo realizado y el sistema conecta los módulos necesarios.</p>
                </div>
        ...
        <form id="atencionRapidaForm"
            ...
            <div class="min-h-0 flex-1 overflow-y-auto px-6 py-6 sm:px-7 sm:py-6">
                <div class="space-y-6">
                    ...
                    <div class="grid gap-6 2xl:grid-cols-[290px_minmax(0,1fr)]">
                        <aside class="space-y-4">
                            <div class="rounded-[28px] border border-slate-200 bg-slate-50 p-5 shadow-sm">
                                ...
                                <div class="mt-4 rounded-[24px] bg-white p-4 shadow-sm">
                                    <img id="atencionRapidaMascotaPhoto" src="{{ asset('storage/default.png') }}" alt="Mascota" class="h-40 w-full rounded-[20px] object-cover" onerror="this.onerror=null;this.src='{{ asset('storage/default.png') }}';">
                                    <div class="mt-4">
                                        <p id="atencionRapidaMascotaName" class="text-[1.75rem] font-bold leading-tight text-slate-900">Selecciona una mascota</p>
                                        <p id="atencionRapidaMascotaOwner" class="mt-1 text-base text-slate-500">El propietario aparecerá aquí.</p>
                                    </div>
                                    <div class="mt-5 grid gap-2 text-sm text-slate-600">
                                        <div class="rounded-2xl bg-blue-50 px-3.5 py-2.5">
                                            <span class="font-semibold text-blue-700">Especie:</span>
                                            <span id="atencionRapidaMascotaTipo" class="ml-1">--</span>
                                        </div>
                                        <div class="rounded-2xl bg-amber-50 px-3.5 py-2.5">
                                            <span class="font-semibold text-amber-700">Color:</span>
                                            <span id="atencionRapidaMascotaColor" class="ml-1">--</span>
                                        </div>
                                        <div class="rounded-2xl bg-emerald-50 px-3.5 py-2.5">
                        ...
                        <div class="space-y-5">
                            <section class="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
                                <div class="flex flex-col gap-3 border-b border-slate-100 pb-5 xl:flex-row xl:items-end xl:justify-between">
                                    <div>
                                        <p class="text-sm font-semibold uppercase tracking-[0.18em] text-slate-400">Datos de la atención</p>
                                        <h4 class="mt-1 text-2xl font-bold tracking-tight text-slate-900">Registro principal</h4>
                                        <p class="mt-1 text-base text-slate-500">Selecciona al paciente, registra la visita y completa solo los bloques que realmente se utilizaron.</p>
                                    </div>
                                ...
                                <div class="mt-6 grid gap-6 2xl:grid-cols-[minmax(0,1.15fr)_minmax(0,0.95fr)]">
                                    <div class="space-y-4">
                                        <div>
                                        ...
                                        <div class="rounded-[24px] border border-emerald-100 bg-emerald-50/40 p-4">
                                        ...
                                        <div class="grid gap-4 lg:grid-cols-2">
                                            <div>
                                                ...
                                                <select id="atencion_rapida_tipo" name="tipo_atencion" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                                            ...
                                            <div>
                                                ...
                                                <select id="atencion_rapida_veterinario_id" name="veterinario_id" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                                        ...
                                        <div class="grid gap-4 lg:grid-cols-3">
                                            <div>
                                                ...
                                                <input id="atencion_rapida_historia_fecha" type="date" name="historia_fecha" value="{{ old('historia_fecha', now()->format('Y-m-d')) }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                                            </div>
                                            <div>
                                                <label for="atencion_rapida_peso" class="mb-2 block text-sm font-semibold text-slate-600">Peso (kg)</label>
                                                <input id="atencion_rapida_peso" type="number" step="0.01" min="0" max="200" name="peso" value="{{ old('peso') }}" placeholder="Ej. 14.20" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                                            </div>
                                            <div>
                                                <label for="atencion_rapida_temperatura" class="mb-2 block text-sm font-semibold text-slate-600">Temperatura (C)</label>
                                                <input id="atencion_rapida_temperatura" type="number" step="0.1" min="30" max="45" name="temperatura" value="{{ old('temperatura') }}" placeholder="Ej. 38.5" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                                            </div>
                                        </div>
                                    </div>

                                    <div id="atencionRapidaClinicalNarrative" class="grid gap-5 xl:grid-cols-2">
                                        <div>
                                            <label for="atencion_rapida_diagnostico" class="mb-2 block text-sm font-semibold text-slate-600">Qué se encontró</label>
                                            <textarea id="atencion_rapida_diagnostico" name="diagnostico" rows="7" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100" placeholder="Escribe el diagnóstico o motivo principal de la atención...">{{ old('diagnostico') }}</textarea>
                                        </div>
                                        <div>
                                            ...
                                            <textarea id="atencion_rapida_observaciones" name="observaciones" rows="7" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100" placeholder="Escribe hallazgos, indicaciones o seguimiento recomendado...">{{ old('observaciones') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
                                <div class="flex flex-col gap-3 border-b border-slate-100 pb-5 xl:flex-row xl:items-end xl:justify-between">
                                    <div>
                                        ...
                                        <h4 class="mt-1 text-2xl font-bold tracking-tight text-slate-900">Servicio, vacuna, tratamiento, receta y seguimiento</h4>
                                        <p class="mt-1 text-base text-slate-500">Completa solo lo necesario. El sistema guardará cada bloque en su módulo correspondiente y evitara duplicar registros.</p>
                                    </div>
                                    <div class="rounded-full bg-slate-100 px-3 py-1.5 text-xs font-semibold text-slate-600">Abre solo lo que necesites</div>
                                </div>

                                <div class="mt-6 grid gap-5 xl:grid-cols-2 2xl:grid-cols-3">
                                    <section class="min-w-0 rounded-[26px] border border-cyan-100 bg-cyan-50/50 p-5 shadow-sm" data-optional-block="servicio" data-open="{{ $hasServicioContent ? 'true' : 'false' }}">
                                        <div class="flex items-center justify-between gap-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h4 class="text-xl font-bold text-slate-900">Servicio</h4>
                                        ...
                                        <div class="mt-5 space-y-4 hidden" data-optional-body>
                                            <div>
                                                ...
                                                <select id="atencion_rapida_servicio_producto_id" name="servicio_producto_id" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100">
                                            ...
                                            <div>
                                                ...
                                                <input id="atencion_rapida_precio_servicio" type="number" step="0.01" min="0" name="precio_servicio" value="{{ old('precio_servicio') }}" placeholder="Ej. 35.00" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100">
                                            </div>
                                        </div>
                                    </section>

                                    <section class="min-w-0 rounded-[26px] border border-blue-100 bg-blue-50/50 p-5 shadow-sm" data-optional-block="vacuna" data-open="{{ $hasVacunaContent ? 'true' : 'false' }}">
                                        <div class="flex items-center justify-between gap-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h4 class="text-xl font-bold text-slate-900">Vacuna</h4>
                                        ...
                                        <div class="mt-5 space-y-4 hidden" data-optional-body>
                                            <div>
                                                ...
                                                <select name="vacuna_nombre_select" id="atencion_rapida_vacuna_nombre_select" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                                            ...
                                            <div id="atencion_rapida_vacuna_custom_wrap" class="{{ $selectedVacunaValue === '__custom__' ? '' : 'hidden' }}">
                                                ...
                                                <input type="text" name="vacuna_nombre_custom" id="atencion_rapida_vacuna_nombre_custom" value="{{ $customVacunaValue }}" placeholder="Escribe el nombre de la vacuna" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                                            </div>
                                            <div>
                                                ...
                                                <input id="atencion_rapida_vacuna_fecha_aplicacion" type="date" name="vacuna_fecha_aplicacion" value="{{ old('vacuna_fecha_aplicacion', now()->format('Y-m-d')) }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                                            </div>
                                            <div class="rounded-2xl border border-blue-100 bg-white/80 p-4">
                                                ...
                                                <div id="atencion_rapida_vacuna_proxima_dosis_wrap" class="{{ old('vacuna_proxima_dosis') ? '' : 'hidden' }} mt-4">
                                                    ...
                                                    <input id="atencion_rapida_vacuna_proxima_dosis" type="date" name="vacuna_proxima_dosis" value="{{ old('vacuna_proxima_dosis') }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                                                </div>
                                            </div>
                                        </div>
                                    </section>

                                    <section class="min-w-0 rounded-[26px] border border-amber-100 bg-amber-50/50 p-5 shadow-sm" data-optional-block="tratamiento" data-open="{{ $hasTratamientoContent ? 'true' : 'false' }}">
                                        <div class="flex items-center justify-between gap-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h4 class="text-xl font-bold text-slate-900">Tratamiento</h4>
                                        ...
                                        <div class="mt-5 space-y-4 hidden" data-optional-body>
                                            <div>
                                                ...
                                                <textarea id="atencion_rapida_tratamiento_descripcion" name="tratamiento_descripcion" rows="5" placeholder="Describe el tratamiento o seguimiento recomendado..." class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-amber-500 focus:ring-4 focus:ring-amber-100">{{ old('tratamiento_descripcion') }}</textarea>
                                            </div>
                                            <div>
                                                <label for="atencion_rapida_tratamiento_costo" class="mb-2 block text-sm font-semibold text-slate-600">Costo estimado</label>
                                                <input id="atencion_rapida_tratamiento_costo" type="number" step="0.01" min="0" name="tratamiento_costo" value="{{ old('tratamiento_costo', 0) }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-amber-500 focus:ring-4 focus:ring-amber-100">
                                            </div>
                                            <div>
                                                ...
                                                <input id="atencion_rapida_tratamiento_fecha_inicio" type="date" name="tratamiento_fecha_inicio" value="{{ old('tratamiento_fecha_inicio', now()->format('Y-m-d')) }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-amber-500 focus:ring-4 focus:ring-amber-100">
                                            </div>
                                            <div>
                                                ...
                                                <input id="atencion_rapida_tratamiento_fecha_fin" type="date" name="tratamiento_fecha_fin" value="{{ old('tratamiento_fecha_fin') }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-amber-500 focus:ring-4 focus:ring-amber-100">
                                            </div>
                                        </div>
                                    </section>

                                    <section class="min-w-0 rounded-[26px] border border-violet-100 bg-violet-50/50 p-5 shadow-sm" data-optional-block="receta" data-open="{{ $hasRecetaContent ? 'true' : 'false' }}">
                                        <div class="flex items-center justify-between gap-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h4 class="text-xl font-bold text-slate-900">Receta</h4>
                                        ...
                                        <div class="mt-5 space-y-4 hidden" data-optional-body>
                                            <div>
                                                ...
                                                <textarea id="atencion_rapida_receta_medicamentos" name="receta_medicamentos" rows="5" placeholder="Escribe los medicamentos o productos indicados..." class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-violet-500 focus:ring-4 focus:ring-violet-100">{{ old('receta_medicamentos') }}</textarea>
                                            </div>
                                            <div>
                                                ...
                                                <textarea id="atencion_rapida_receta_indicaciones" name="receta_indicaciones" rows="5" placeholder="Escribe dosis, frecuencia y recomendaciones para el propietario..." class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-violet-500 focus:ring-4 focus:ring-violet-100">{{ old('receta_indicaciones') }}</textarea>
                                            </div>
                                        </div>
                                    </section>

                                    <section class="min-w-0 rounded-[26px] border border-rose-100 bg-rose-50/50 p-5 shadow-sm" data-optional-block="seguimiento" data-open="{{ $hasSeguimientoContent ? 'true' : 'false' }}">
                                        <div class="flex items-center justify-between gap-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h4 class="text-xl font-bold text-slate-900">Próximo control</h4>
                                        ...
                                        <div class="mt-5 space-y-4 hidden" data-optional-body>
                                            ...
                                            <div>
                                                ...
                                                <textarea id="atencion_rapida_seguimiento_motivo" name="seguimiento_motivo" rows="4" placeholder="Ej. Control por diarrea, vomitos, revisión de herida o respuesta al tratamiento..." class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-rose-500 focus:ring-4 focus:ring-rose-100">{{ old('seguimiento_motivo') }}</textarea>
                                            </div>
                                            <div class="grid gap-4 md:grid-cols-3">
                                                <div>
                                                    ...
                                                    <input id="atencion_rapida_seguimiento_dias_retorno" type="number" min="1" max="365" name="seguimiento_dias_retorno" value="{{ old('seguimiento_dias_retorno') }}" placeholder="Ej. 3" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-rose-500 focus:ring-4 focus:ring-rose-100">
                                                </div>
                                                <div>
                                                    ...
                                                    <input id="atencion_rapida_seguimiento_fecha_proximo_control" type="date" name="seguimiento_fecha_proximo_control" value="{{ old('seguimiento_fecha_proximo_control') }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-rose-500 focus:ring-4 focus:ring-rose-100">
                                                </div>
                                                <div>
