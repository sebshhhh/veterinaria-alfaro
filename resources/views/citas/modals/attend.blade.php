...
<div id="attendCitaModal"
    ...
    <div class="flex min-h-full items-center justify-center">
        <div class="flex max-h-[calc(100vh-3rem)] w-full max-w-[96rem] flex-col overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-2xl shadow-slate-900/20">
            <div class="shrink-0 border-b border-slate-100 bg-white px-6 py-5 sm:px-7 sm:py-6">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <h3 id="attendCitaTitle" class="mt-1 text-[2rem] font-bold tracking-tight text-slate-900">Atender cita</h3>
                        <p id="attendCitaSummary" class="mt-1.5 text-base text-slate-500">Usa el mismo flujo de Nueva atención: registra solo lo realizado y el sistema conecta los módulos necesarios.</p>
                    </div>
                            ...
                            <aside class="space-y-4">
                                <div class="rounded-[28px] border border-slate-200 bg-slate-50 p-5 shadow-sm">
                                    ...
                                    <div class="mt-4 rounded-[24px] bg-white p-4 shadow-sm">
                                        <img id="attendMascotaPhoto" src="{{ asset('storage/default.png') }}" alt="Mascota" class="h-48 w-full rounded-[20px] object-cover" onerror="this.onerror=null;this.src='{{ asset('storage/default.png') }}';">
                                        <div class="mt-4">
                                            <p id="attendMascotaName" class="text-2xl font-bold text-slate-900">Mascota seleccionada</p>
                                            <p id="attendMascotaOwner" class="mt-1 text-base text-slate-500">El due&ntilde;o aparecerá aquí.</p>
                                        </div>
                                ...
                                <section class="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
                                    <div class="flex flex-col gap-2 border-b border-slate-100 pb-4 xl:flex-row xl:items-end xl:justify-between">
                                        <div>
                                            ...
                                            <h4 class="mt-1 text-xl font-bold text-slate-900">Registro principal</h4>
                                            <p class="mt-1 text-sm text-slate-500">Aqui se guarda lo esencial de la visita para alimentar el historial de la mascota.</p>
                                        </div>
                                    ...
                                    <div class="mt-5 grid gap-5 xl:grid-cols-2">
                                        <div class="xl:col-span-2 rounded-[24px] border border-blue-100 bg-blue-50/40 p-4">
                                        ...
                                        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4 xl:col-span-2">
                                            <div>
                                                ...
                                                <select id="attend_tipo_atencion" name="tipo_atencion" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                                            ...
                                            <div>
                                                ...
                                                <input id="historia_fecha" type="date" name="historia_fecha" value="{{ old('historia_fecha', now()->format('Y-m-d')) }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                                            </div>
                                            <div>
                                                <label for="attend_peso" class="mb-2 block text-sm font-semibold text-slate-600">Peso (kg)</label>
                                                <input id="attend_peso" type="number" step="0.01" min="0" max="200" name="peso" value="{{ old('peso') }}" placeholder="Ej. 14.20" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                                            </div>
                                            <div>
                                                <label for="attend_temperatura" class="mb-2 block text-sm font-semibold text-slate-600">Temperatura (°C)</label>
                                                <input id="attend_temperatura" type="number" step="0.1" min="30" max="45" name="temperatura" value="{{ old('temperatura') }}" placeholder="Ej. 38.5" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                                            </div>
                                        </div>

                                        <div id="attendClinicalNarrative" class="grid gap-5 xl:grid-cols-2 xl:col-span-2">
                                            <div>
                                                <label for="diagnostico" class="mb-2 block text-sm font-semibold text-slate-600">Diagnostico</label>
                                                <textarea id="diagnostico" name="diagnostico" rows="6" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100" placeholder="Describe el diagnóstico principal de la consulta...">{{ old('diagnostico') }}</textarea>
                                            </div>
                                            <div>
                                                <label for="observaciones" class="mb-2 block text-sm font-semibold text-slate-600">Observaciones</label>
                                                <textarea id="observaciones" name="observaciones" rows="6" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100" placeholder="Notas medicas, hallazgos o seguimiento recomendado...">{{ old('observaciones') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section class="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
                                    <div class="flex flex-col gap-2 border-b border-slate-100 pb-4 xl:flex-row xl:items-end xl:justify-between">
                                        <div>
                                            ...
                                            <h4 class="mt-1 text-xl font-bold text-slate-900">Servicio, vacuna, tratamiento, receta y seguimiento</h4>
                                            <p class="mt-1 text-sm text-slate-500">Completa solo lo que realmente se aplicó o indicó durante esta atención.</p>
                                        </div>
                                    ...
                                    <div id="attendClinicalBlocks" class="mt-5 grid gap-5 xl:grid-cols-2 2xl:grid-cols-3">
                                        <section id="attendServicioBlock" class="min-w-0 rounded-[26px] border border-cyan-100 bg-cyan-50/50 p-5 shadow-sm" data-optional-block="servicio" data-open="{{ $hasServicioContent ? 'true' : 'false' }}">
                                            <div class="flex items-center justify-between gap-3">
                                            ...
                                            <div class="mt-5 space-y-4 hidden" data-optional-body>
                                                <div>
                                                    ...
                                                    <select id="attend_servicio_producto_id" name="servicio_producto_id" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100">
                                                ...
                                                <div>
                                                    ...
                                                    <input id="attend_precio_servicio" type="number" step="0.01" min="0" name="precio_servicio" value="{{ old('precio_servicio') }}" placeholder="Ej. 35.00" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100">
                                                </div>
                                            </div>
                                        </section>

                                        <section class="min-w-0 rounded-[26px] border border-emerald-100 bg-emerald-50/50 p-5 shadow-sm" data-optional-block="vacuna" data-open="{{ $selectedVacunaValue || $customVacunaValue || old('vacuna_proxima_dosis') ? 'true' : 'false' }}">
                                            <div class="flex items-center justify-between gap-3">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <h4 class="text-xl font-bold text-slate-900">Vacuna aplicada</h4>
                                            ...
                                            <div class="mt-5 space-y-4 hidden" data-optional-body>
                                                <div>
                                                    ...
                                                    <select name="vacuna_nombre_select" id="attend_vacuna_nombre_select" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                                                ...
                                                <div id="attend_vacuna_custom_wrap" class="{{ $selectedVacunaValue === '__custom__' ? '' : 'hidden' }}">
                                                    ...
                                                    <input type="text" name="vacuna_nombre_custom" id="attend_vacuna_nombre_custom" value="{{ $customVacunaValue }}" placeholder="Escribe el nombre de la vacuna" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                                                </div>
                                                <div>
                                                    <label for="attend_vacuna_fecha_aplicacion" class="mb-2 block text-sm font-semibold text-slate-600">Fecha de aplicacion</label>
                                                    <input id="attend_vacuna_fecha_aplicacion" type="date" name="vacuna_fecha_aplicacion" value="{{ old('vacuna_fecha_aplicacion', now()->format('Y-m-d')) }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                                                ...
                                                <div class="rounded-2xl border border-emerald-100 bg-white/80 p-4">
                                                    ...
                                                    <div id="attend_vacuna_proxima_dosis_wrap" class="{{ old('vacuna_proxima_dosis') ? '' : 'hidden' }} mt-4">
                                                        ...
                                                        <input id="attend_vacuna_proxima_dosis" type="date" name="vacuna_proxima_dosis" value="{{ old('vacuna_proxima_dosis') }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100">
                                                    </div>
                                                </div>
                                            </div>
                                        </section>

                                        <section class="min-w-0 rounded-[26px] border border-amber-100 bg-amber-50/50 p-5 shadow-sm" data-optional-block="tratamiento" data-open="{{ old('tratamiento_descripcion') || old('tratamiento_fecha_fin') || (float) old('tratamiento_costo', 0) > 0 ? 'true' : 'false' }}">
                                            <div class="flex items-center justify-between gap-3">
                                                <div class="flex items-center gap-3">
                                            ...
                                            <div class="mt-5 space-y-4 hidden" data-optional-body>
                                                <div>
                                                    ...
                                                    <textarea id="attend_tratamiento_descripcion" name="tratamiento_descripcion" rows="5" placeholder="Descripción del tratamiento..." class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-amber-500 focus:ring-4 focus:ring-amber-100">{{ old('tratamiento_descripcion') }}</textarea>
                                                </div>
                                                <div>
                                                    <label for="attend_tratamiento_costo" class="mb-2 block text-sm font-semibold text-slate-600">Costo</label>
                                                    <input id="attend_tratamiento_costo" type="number" step="0.01" min="0" name="tratamiento_costo" value="{{ old('tratamiento_costo', 0) }}" placeholder="Costo" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-amber-500 focus:ring-4 focus:ring-amber-100">
                                                </div>
                                                <div>
                                                    <label for="attend_tratamiento_fecha_inicio" class="mb-2 block text-sm font-semibold text-slate-600">Fecha de inicio</label>
                                                    <input id="attend_tratamiento_fecha_inicio" type="date" name="tratamiento_fecha_inicio" value="{{ old('tratamiento_fecha_inicio', now()->format('Y-m-d')) }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-amber-500 focus:ring-4 focus:ring-amber-100">
                                                </div>
                                                <div>
                                                    <label for="attend_tratamiento_fecha_fin" class="mb-2 block text-sm font-semibold text-slate-600">Fecha de fin</label>
                                                    <input id="attend_tratamiento_fecha_fin" type="date" name="tratamiento_fecha_fin" value="{{ old('tratamiento_fecha_fin') }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-amber-500 focus:ring-4 focus:ring-amber-100">
                                                    <p class="mt-1.5 text-sm leading-5 text-slate-500">Dejala vacia si el tratamiento sigue activo.</p>
                                                </div>
                                            </div>
                                        </section>

                                        <section class="min-w-0 rounded-[26px] border border-blue-100 bg-blue-50/50 p-5 shadow-sm" data-optional-block="receta" data-open="{{ old('receta_medicamentos') || old('receta_indicaciones') ? 'true' : 'false' }}">
                                            <div class="flex items-center justify-between gap-3">
                                                <div class="flex items-center gap-3">
                                            ...
                                            <div class="mt-5 space-y-4 hidden" data-optional-body>
                                                <div>
                                                    ...
                                                    <textarea id="attend_receta_medicamentos" name="receta_medicamentos" rows="5" placeholder="Medicamentos usados o recetados..." class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100">{{ old('receta_medicamentos') }}</textarea>
                                                </div>
                                                <div>
                                                    <label for="attend_receta_indicaciones" class="mb-2 block text-sm font-semibold text-slate-600">Indicaciones</label>
                                                    <textarea id="attend_receta_indicaciones" name="receta_indicaciones" rows="5" placeholder="Indicaciones de uso, dosis y frecuencia..." class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-100">{{ old('receta_indicaciones') }}</textarea>
                                                </div>
                                            </div>
                                        </section>
                                        ...
                                        <section class="min-w-0 rounded-[26px] border border-rose-100 bg-rose-50/50 p-5 shadow-sm" data-optional-block="seguimiento" data-open="{{ $hasSeguimientoContent ? 'true' : 'false' }}">
                                            ...
                                            <div class="mt-5 space-y-4 hidden" data-optional-body>
                                                ...
                                                <div>
                                                    ...
                                                    <textarea id="attend_seguimiento_motivo" name="seguimiento_motivo" rows="4" placeholder="Ej. Control por diarrea, revisión de herida o respuesta a medicación..." class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-rose-500 focus:ring-4 focus:ring-rose-100">{{ old('seguimiento_motivo') }}</textarea>
                                                </div>
                                                <div class="grid gap-4 md:grid-cols-3">
                                                    <div>
                                                        ...
                                                        <input id="attend_seguimiento_dias_retorno" type="number" min="1" max="365" name="seguimiento_dias_retorno" value="{{ old('seguimiento_dias_retorno') }}" placeholder="Ej. 3" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-rose-500 focus:ring-4 focus:ring-rose-100">
                                                    </div>
                                                    <div>
                                                        ...
                                                        <input id="attend_seguimiento_fecha_proximo_control" type="date" name="seguimiento_fecha_proximo_control" value="{{ old('seguimiento_fecha_proximo_control') }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-rose-500 focus:ring-4 focus:ring-rose-100">
                                                    </div>
                                                    <div>
                                                        ...
                                                        <input id="attend_seguimiento_hora_proximo_control" type="time" name="seguimiento_hora_proximo_control" value="{{ old('seguimiento_hora_proximo_control', '09:00') }}" class="w-full rounded-2xl border border-slate-200 px-4 py-3.5 text-base text-slate-700 shadow-sm focus:border-rose-500 focus:ring-4 focus:ring-rose-100">
                                                    </div>
                                                </div>
                                                <div>
